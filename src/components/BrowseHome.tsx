 ...
 * and the site mode is visual. Search lives in the nav (BrowseHeader's
 * search slot); everything here is browse content. Layer one (the full
 * search and filter surface in BrowseShell) is one action away: any tile,
 * shelf title, or cover pushes a filter URL.
 */
export function BrowseHome({ shelves, fandoms, covers }: Props) {
  return (
    <>
      <HeroCarousel />
